...
//
//	const char* const kShootAnimName = "CharacterArmature|Idle_Shoot";
//}
//
//
...
//{
//	
//	m_finalScore = Player::GetJustCount();
//
//	//アニメ進行
...
//		m_effectManger.PlayEffect(EffectManager::EffectType::Hit, m_effectPos);
//	}
